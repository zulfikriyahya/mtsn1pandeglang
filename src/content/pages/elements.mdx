...
<div style={{ display: "flex", flexWrap: "wrap", gap: "16px" }}>
    <div style={{ flex: "1 1 320px", aspectRatio: "16/9" }}>
        <img
        src="https://daftar.mtsn1pandeglang.sch.id/storage/berkas/foto/3129339851/01JSX0Y8WE9ASWSXE7M5B6VQK2.jpeg"
        alt="image"
        style={{ width: "100%" }}
        />
    </div>
...
<div style={{ display: "flex", flexWrap: "wrap", gap: "16px" }}>
  <div style={{ flex: "1 1 320px", aspectRatio: "16/9" }}>
    <iframe
      src="https://www.youtube.com/embed/rZNgKNkfaMM"
...
<Youtube client:load id="rZNgKNkfaMM" title="Play:Youtube" width="300"
  height="168" />
...
<Video width="100%" src="https://daftar.mtsn1pandeglang.sch.id/storage/berkas/foto/3129339851/01JSX0Y8WE9ASWSXE7M5B6VQK2.jpeg" />
