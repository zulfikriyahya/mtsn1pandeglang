...
try {
    ...
    {
        // ... (Kode format tanggal tetap sama)
        try {
    ...
    // Helper: Daily Activity (Sama seperti sebelumnya)
    ...
    if ($action === 'stats') {
        ...
        // Data Kunjungan (Limit 1000 terakhir agar tidak berat)
        $visit_logs = [];
